...
echo "$($PSQL "SELECT DISTINCT name FROM teams t JOIN games g ON t.team_id = g.winner_id OR t.team_id = g.opponent_id WHERE g.year = 2014  AND g.round = 'Eighth-Final' ORDER BY name;")"
